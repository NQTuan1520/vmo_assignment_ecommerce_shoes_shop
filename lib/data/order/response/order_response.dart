...
class OrderDataResponse extends OrderDataEntity {
  @override
  ...
  factory OrderDataResponse.fromJson(Map<String, dynamic> json) => _$OrderDataResponseFromJson(json);
...
@JsonSerializable(genericArgumentFactories: true, explicitToJson: true)
class OrderMetaResponse extends OrderMetaEntity {
  @override
  @JsonKey(name: 'pagination')
  final PaginationResponse? pagination;

  const OrderMetaResponse({
    this.pagination,
  });

  factory OrderMetaResponse.fromJson(Map<String, dynamic> json) => _$OrderMetaResponseFromJson(json);

  Map<String, dynamic> toJson() => _$OrderMetaResponseToJson(this);
}
