...
class CaptureOrderResponseEntity extends Equatable {
  ...
  const CaptureOrderResponseEntity({
    this.version,
    this.sandbox,
    this.id,
  ...
  CaptureOrderResponseEntity copyWith({
    String? version,
    bool? sandbox,
    String? id,
    ...
    return CaptureOrderResponseEntity(
